...
/*
 * idea is to take 12:00 (h = 12, m = 0) as a reference. Following are detailed steps.

1) Calculate the angle made by hour hand with respect to 12:00 in h hours and m minutes.
2) Calculate the angle made by minute hand with respect to 12:00 in h hours and m minutes.
3) The difference between two angles is the angle between two hands.
 */
public class Clock_HourMinute_Angle {
	 ...
	 * 
	 * In h hours and m minutes, the minute hand would move (h*60 + m)*6 and hour
	 * hand would move (h*60 + m)*0.5.
	 */
