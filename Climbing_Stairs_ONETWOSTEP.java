...
public class Climbing_Stairs_ONETWOSTEP {

	/*
	 * The problem seems to be a dynamic programming one. Hint: the tag also
	 * suggests that! Here are the steps to get the solution incrementally.
	 * 
	 * Base cases: if n <= 0, then the number of ways should be zero.
	 ...
	 * 
	 * The solutions calculated by the above approach are complete and
	 * non-redundant (not repeated or without repetation). The two solution sets (n1 and n2) cover all the possible cases
	 * on how the final step is taken. And there would be NO overlapping among the
	 * final solutions constructed from these two solution sets, because they differ
	 * in the final step.
	 * 
