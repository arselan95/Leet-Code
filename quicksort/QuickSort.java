...
The key process in quickSort is partition().
 Target of partitions is, given an array and an element x of array as pivot, put x at 
 its correct position in sorted array and put all smaller elements (smaller than x) before x, 
 ...
 * 
 * 
 * Best Case: The best case occurs when the partition
 *  process always picks the middle element as pivot. 
