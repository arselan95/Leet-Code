package hashTable;
/*
 * In our solution, we use an array to represent the hash set. 
 * Each element in the array is a bucket. And in each bucket, we use the array list (or vector in C++)
